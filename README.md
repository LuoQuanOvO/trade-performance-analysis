...
**期现正套损益测算(买入现货+卖出期货,资金成本年化4.5%)**:当前基差 +15(期货升水),
按基差回归平水计算,正套边际收益约+15元/吨,扣除30天资金成本约11.6元/吨后**净收益约+3元/吨**(盈亏平衡基差+3.3),
薄利覆盖成本,S2止盈/离场区提示——升水空间有限,正套性价比一般。

**跟踪信号表**:以"基差分位 + 库存拐点 + 盘面利润"三维触发,
当前 S2收敛止盈、S5增产压力已触发(S1基差修复观察、S3基差修复受阻未触发)。
...
框架是常驻的——当前期货升水处于高位分位,正套收益仅薄利,关注库存拐点与基差回落后的再平衡机会。
